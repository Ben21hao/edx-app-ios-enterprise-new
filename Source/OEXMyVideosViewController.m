...
//    self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@" " style:UIBarButtonItemStylePlain target:nil action:nil];
    ...
    [self setTitleLabel];
//    self.title = TDLocalizeSelect(@"MY_VIDEOS", nil);
...
//    closeButton.accessibilityLabel = TDLocalizeSelect(@"ACCESSIBILITY_MENU", nil);
...
//    [self.navigationController setNavigationBarHidden:false animated:animated];
    ...
    self.lbl_NoVideo.text = TDLocalizeSelect(@"NO_VIDEOS_DOWNLOADED", nil);
...
- (void)setTitleLabel {
    ...
    self.titleViewLabel.text = TDLocalizeSelect(@"MY_VIDEOS", nil);
...
- (UICollectionViewCell*)collectionView:(UICollectionView*)collectionView cellForItemAtIndexPath:(NSIndexPath*)indexPath {
    ...
    switch(indexPath.row) {
        case 0:
            title = TDLocalizeSelect(@"allVideos", nil);//.oex_uppercaseStringInCurrentLocale;
            break;

        case 1:
            title = TDLocalizeSelect(@"RECHARGE_BAODIAN", nil);//.oex_uppercaseStringInCurrentLocale;
            break;
...
- (void)showAlert:(OEXAlertType )OEXAlertType {
    ...
    switch(OEXAlertType) {
        case OEXAlertTypeDeleteConfirmationAlert: {
            NSString* message = TDLocalizeSelect(@"CONFIRM_DELETE_MESSAGE_TEXT", nil);
