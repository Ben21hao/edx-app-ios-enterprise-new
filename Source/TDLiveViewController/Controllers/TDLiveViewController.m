...
@interface TDLiveViewController () <UIScrollViewDelegate>
...
@implementation TDLiveViewController
...
- (void)addAllChildrenView {
    ...
    for (int i = 0; i < 2 ; i ++ ) {
        TDLiveSubViewController *subViewController = [[TDLiveSubViewController alloc] init];
