...
- (id)initWithCoder:(NSCoder*)aDecoder {
    ...
    if(self) {
        ...
        [self.btn_Cancel setTitle:TDLocalizeSelect(@"CANCEL", nil) forState:UIControlStateNormal];
        ...
        [self.btn_Edit setTitle:TDLocalizeSelect(@"EDIT", nil) forState:UIControlStateNormal];
        ...
        [self.btn_Delete setTitle:TDLocalizeSelect(@"DELETE", nil) forState:UIControlStateNormal];
