...
//        NSString * base64String = base64StringFromData([NSData dataWithBytes:sig length:sig_len]);
        NSString *base64String = @"FklU+9y1JTeNPatK8bpWnTxxW6ZWS6jJtpJk0Y88hje07h95S2C3VHabKABP+R8Uc8fIXY6hKj/4jchYYP0jZAsNly5xBa8jJ/ApAtdrGRK+9HaFIJ8NPLK0kL921gWYx3QReanOxJAhlDOjqwWcwm7Pr1CbzZNizrCivZbc27Y=";
