...
- (void)exchangeAction {
    ...
    self.exchangeAlertView = [[WYAlertView alloc] initWithTitle:TDLocalizeSelect(@"EXCHANGE_COUPON", nil) message:nil cancelButtonTitle:TDLocalizeSelect(@"CANCEL", nil) rightButtonTitle:TDLocalizeSelect(@"OK", nil) beTextField:YES];
    self.exchangeAlertView.text.placeholder = TDLocalizeSelect(@"ENTER_COUPON_NUM", nil);
